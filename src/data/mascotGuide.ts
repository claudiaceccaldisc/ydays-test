...
export const mascotGuideContent: Record<MascotMood, MascotGuideEntry> = {
  welcome: {
    ...
    title: "Bienvenue",
    message: "Je suis la pour te guider pas a pas dans l'application.",
    accent: "#2456D3",
  },
  question: {
    image: "/assets/mascot/mascotte_question.png",
    title: "Une question ?",
    message: "Prends un instant pour verifier les informations avant d'avancer.",
    accent: "#6F9D8D",
  },
  success: {
    image: "/assets/mascot/mascotte_bonne-réponse.png",
    title: "Bravo",
    message: "Tout est valide, tu peux continuer en confiance.",
    accent: "#2456D3",
  },
  warning: {
    image: "/assets/mascot/mascotte_mauvaise-réponse.png",
    title: "Attention",
    message: "Un point demande une verification avant la prochaine etape.",
    accent: "#D97A5A",
  },
  tip: {
    image: "/assets/mascot/mascotte_astuce.png",
    title: "Petit conseil",
    message: "Un bon detail maintenant peut te faire gagner du temps ensuite.",
    accent: "#6F9D8D",
  },
  finish: {
    image: "/assets/mascot/mascotte_fin.png",
    title: "Mission terminee",
    message: "Le parcours est fini, il ne reste plus qu'a valider le resultat.",
    accent: "#16213E",
  },
  confidentiality: {
